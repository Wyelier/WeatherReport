    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inm.hideSoftInputFromWindow(getCurrentFocus().getRootView().getWindowToken(), 0);
            ...
            private void api_key(final String City) {
                ...
                Request request = new Request.Builder()
                        .url("https://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=06a44056663b8e322d3d94ee23315fbc&units=metric")
                        .get()
                        .build();
